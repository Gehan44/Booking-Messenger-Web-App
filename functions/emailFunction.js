...
module.exports = async function emailRun(mailT,mailSend) {
    ...
    `;
        ...
        <p style="font-size: 26px;">เรียนคุณ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${mailT.dispName}</p>
        <p style="font-size: 26px;">เลขที่ใบงาน &nbsp;&nbsp;&nbsp; ${mailT.docID}</p>
        <p style="font-size: 26px;">สถานะ &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: red;">ไม่ถูกนำส่ง</span> </p>
    ...
    let mail;
    if (mailSend === null) {
        mail = 'salesupport@pinewealthsolution.com'
    } else {
        mail = `${mailSend},salesupport@pinewealthsolution.com`
    }
